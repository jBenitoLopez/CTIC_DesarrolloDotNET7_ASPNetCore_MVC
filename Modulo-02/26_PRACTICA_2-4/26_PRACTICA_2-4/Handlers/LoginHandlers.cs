...
namespace _26_PRACTICA_2_4.Handlers
{
    public class LoginHandlers
    {
        ...
        public static async Task DoLoginAsync(HttpContext context)
        {
            ...
            //    Por simplificar, podemos considerar correctas las credenciales cuando username == password
            if (string.IsNullOrEmpty(username) || string.IsNullOrEmpty(password) || username != password)
            {
                var body = @"<h1>Invalid credentials</h1>
